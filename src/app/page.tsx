...
export default function Home() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="mt-5 flex-1 overflow-x-clip">
        <div className="relative h-full">
          <HomeNeuralMap nodes={neuralNodes} />

          <details className="group absolute bottom-4 left-1/2 z-30 w-[calc(100%-2rem)] max-w-[22rem] -translate-x-1/2 rounded-2xl border border-border/70 bg-background/80 shadow-lg backdrop-blur-xl md:left-auto md:right-4 md:w-[min(88vw,22rem)] md:translate-x-0">
