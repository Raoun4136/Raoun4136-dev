...
const Ground = () => {
  ...
  const gridMap = useLoader(TextureLoader, '/car-game/textures/grid.png');

  const aoMap = useLoader(TextureLoader, '/car-game/textures/ground-ao.png');

  const alphaMap = useLoader(TextureLoader, '/car-game/textures/alpha-map.png');
