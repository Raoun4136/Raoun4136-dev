...
![`i18n script 실행결과 - all`](https://n3wwjaaqoexznnte.public.blob.vercel-storage.com/mdx/images/i18n-spread-sheet/script-result-all.png)
![`i18n script 실행결과 - common`](https://n3wwjaaqoexznnte.public.blob.vercel-storage.com/mdx/images/i18n-spread-sheet/script-result-common.png)
